...
@Entity
@Table(name = "T5_UNDANGAN_V_K")
@TableGenerator(name = "tableSequence", table = "SEQUENCE", pkColumnName = "TABLE_SEQ_NAME", 
valueColumnName = "TABLE_SEQ_VALUE", pkColumnValue = "T5_UNDANGAN_V_K", initialValue = 1, allocationSize = 1)
public class UndanganVendorKualifikasi {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "UNDANGAN_V_K_ID")
	private Integer id;
