...
@Entity
@Table(name = "T5_PENGUMUMAN_P")
@TableGenerator(name = "tableSequence", table = "SEQUENCE", pkColumnName = "TABLE_SEQ_NAME", 
valueColumnName = "TABLE_SEQ_VALUE", pkColumnValue = "T5_PENGUMUMAN_P", initialValue = 1, allocationSize = 1)
public class PengumumanPengadaan {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "PENGUMUMAN_PENGADAAN_ID")
	private Integer id;
