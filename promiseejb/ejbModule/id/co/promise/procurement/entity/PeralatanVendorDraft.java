...
@Entity
@Table(name = "T3_PERALATAN_V_DRAFT")
@NamedQueries({
	@NamedQuery(name="PeralatanVendorDraft.findByVendor", query="SELECT peralatanVendorDraft FROM PeralatanVendorDraft peralatanVendorDraft WHERE peralatanVendorDraft.vendor.id =:vendorId AND peralatanVendorDraft.isDelete=0"),
	@NamedQuery(name="PeralatanVendorDraft.findByVendorAndPeralatanVendor",query="SELECT peralatanVendorDraft FROM PeralatanVendorDraft peralatanVendorDraft WHERE peralatanVendorDraft.vendor.id =:vendorId AND peralatanVendorDraft.peralatanVendor.id=:peralatanVendorId AND peralatanVendorDraft.isDelete = 0"),
	@NamedQuery(name ="PeralatanVendorDraft.deletePeralatanVendorDraft", 
				query ="UPDATE PeralatanVendorDraft peralatanVendorDraft set peralatanVendorDraft.isDelete = 1 WHERE peralatanVendorDraft.vendor.id =:vendorId ")
})
@TableGenerator(name = "tableSequence", table = "SEQUENCE", pkColumnName = "TABLE_SEQ_NAME", 
valueColumnName = "TABLE_SEQ_VALUE", pkColumnValue = "T3_PERALATAN_V_DRAFT", initialValue = 1, allocationSize = 1)
public class PeralatanVendorDraft {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "PERALATAN_VENDOR_DRAFT_ID")
	private Integer id;
	...
	@OneToOne
	@JoinColumn(name = "PERALATAN_VENDOR_ID", referencedColumnName = "PERALATAN_VENDOR_ID")
