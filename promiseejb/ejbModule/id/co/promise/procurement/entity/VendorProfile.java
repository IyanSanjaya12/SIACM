...
@Entity
@Table(name = "T3_VENDOR_PROFILE")
@NamedQueries({
	@NamedQuery(name="VendorProfile.findByVendor",
        	query="SELECT vendorProfile FROM VendorProfile vendorProfile WHERE vendorProfile.vendor.id=:vendorId AND vendorProfile.isDelete = 0"),
    @NamedQuery(name="VendorProfile.findByNoPKP",
        	query="SELECT vendorProfile FROM VendorProfile vendorProfile WHERE vendorProfile.nomorPKP=:nomorPKP AND vendorProfile.isDelete = 0"),
    @NamedQuery(name="VendorProfile.findByNoNPWP",
			query="SELECT vendorProfile FROM VendorProfile vendorProfile WHERE vendorProfile.npwpPerusahaan=:npwpPerusahaan AND vendorProfile.isDelete = 0")
})

@TableGenerator(name = "tableSequence", table = "SEQUENCE", pkColumnName = "TABLE_SEQ_NAME", 
valueColumnName = "TABLE_SEQ_VALUE", pkColumnValue = "T3_VENDOR_PROFILE", initialValue = 1, allocationSize = 1)
