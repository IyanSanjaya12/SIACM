...
@Entity
@NamedQueries({ @NamedQuery(name = "VendorApproval.getList", query = "SELECT sp FROM VendorApproval sp WHERE sp.isDelete = 0") })
@Table(name = "T5_VENDOR_APPROVAL")
@TableGenerator(name = "tableSequence", table = "SEQUENCE", pkColumnName = "TABLE_SEQ_NAME", 
valueColumnName = "TABLE_SEQ_VALUE", pkColumnValue = "T5_VENDOR_APPROVAL", initialValue = 1, allocationSize = 1)
