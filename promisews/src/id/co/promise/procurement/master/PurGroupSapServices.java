 ...
 */
@Stateless
@Path(value = "/procurement/master/pur-group")
@Produces(MediaType.APPLICATION_JSON)
public class PurGroupSapServices {
	final static Logger log = Logger.getLogger(PurGroupSapServices.class);

	@EJB private PurGroupSapSession purGroupSapSession;
	...
	public Response getList(
		...
		try {
			return Response.status(201).entity(purGroupSapSession.getList()).build();
		} catch (Exception e) {
