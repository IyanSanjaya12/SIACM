...
@Stateless
@Path("/catalog/AttributeGroupPortalServices")
@Produces(MediaType.APPLICATION_JSON)
public class MasterAttributeGroupPortalServices {
	...
	public List<AttributeGroup> findByCategory (CatalogVendor catalogVendor) {
		...
		List<Catalog> catalogList = catalogCategorySession.getCatalogList(catalogVendor);
