/**=========================================================
 * Module: PemasukanPenawaranSatuanTertutupAddController.js
 * Author: F.H.K
 =========================================================*/
...
(function() {
    ...
    angular
        .module('naut')
        .controller('PemasukanPenawaranSatuanTertutupAddController', PemasukanPenawaranSatuanTertutupAddController);

    function PemasukanPenawaranSatuanTertutupAddController($http, $rootScope, $resource, $location, $window, toaster, $scope, $filter, ngTableParams) {
        ...
        $scope.simpanPenawaran = function() {
			...
			//console.log("DATA PENAWARAN VENDOR = " + JSON.stringify(dataPVL));
	...
	PemasukanPenawaranSatuanTertutupAddController.$inject = ['$http', '$rootScope', '$resource', '$location', '$window', 'toaster', '$scope', '$filter', 'ngTableParams'];
