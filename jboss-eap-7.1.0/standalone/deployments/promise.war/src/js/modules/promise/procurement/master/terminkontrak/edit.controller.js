(function () {
    ...
    angular.module('naut').controller('TerminKontrakUbahController', TerminKontrakUbahController);

    function TerminKontrakUbahController($scope, $http, $rootScope, $resource, $location, $filter, toaster) {
        var form = this;
        var dataTerminkontrak;
        form.jenisTermin = {};
        form.mataUang = {};
        form.kontrak = {};

        if (typeof $rootScope.indexTerminKontrak !== 'undefined') {
            dataTerminkontrak = $rootScope.indexTerminKontrak;
        }
        form.id = dataTerminkontrak.id;
        form.tanggal = dataTerminkontrak.tanggal;
        form.nilai = dataTerminkontrak.nilai;
        form.nilaiTukar = dataTerminkontrak.nilaiTukar;
        form.keterangan = dataTerminkontrak.keterangan;
        form.jenisTermin.selected = dataTerminkontrak.jenisTermin;
        form.mataUang.selected = dataTerminkontrak.mataUang;
        form.kontrak.selected = dataTerminkontrak.kontrak;
        ...
        form.simpan = function () {
            if (typeof form.tanggal === 'undefined' || form.tanggal == null) {
                ...
                $http({
                    method: 'POST',
                    url: $rootScope.backendAddress + '/procurement/TerminKontrakServices/update',
                    headers: {
    ...
    TerminKontrakUbahController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', '$filter', 'toaster'];
