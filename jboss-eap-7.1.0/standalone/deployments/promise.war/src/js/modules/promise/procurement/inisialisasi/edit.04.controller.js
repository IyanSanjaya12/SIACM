(function () {
    ...
    angular
        .module('naut')
        .controller('InisialisasiPengadaan04EditController', InisialisasiPengadaanBumnEditController)
        .filter('propsFilter', propsFilter);

    function InisialisasiPengadaanBumnEditController(ModalService, $scope, $http, $rootScope, $resource, $location, toaster, $filter, ngTableParams, $modal, FileUploader, $q, $stateParams, RequestService) {
        var vm = this;
        $scope.loading = true;
        ...
        $scope.btnGenerateNumber = function() {
			...
			.success(function(data, status, headers, config) {
				vm.dataPengadaan.nomorNotaDinas = data.PA;				
        ...
        vm.goToTabDokumen = function () {
            ...
            //kondisi undangan vendor ada jika metode pengadaa : 5=penunjukan langsung & 4=pemilihan langsung
            if (vm.dataPengadaan.metodePengadaan.id === 5 || vm.dataPengadaan.metodePengadaan.id === 4) {
                //jika tidak ada data vendor, kondisi diatas wajin ada undangan vendor
            ...
            if (validateTabVendor) {
                ...
                vm.tabActiveStatus.tabVendor = true;
                vm.tabActiveStatus.tabDokumen = false;
                RequestService.modalInformation('Vendor yang diundang harus ada!', 'danger')
                    .then(function (rs) {
                        console.log('Vendor yang diundang harus ada.');
                    });
            } else {
                vm.tabActiveStatus.tabGeneral = false;
                vm.tabActiveStatus.tabRules = false;
        ...
        $scope.alurSelected = vm.dataPengadaan.alurPengadaan.id;
        $scope.getAlurPengadaanList = function () {
            $scope.loading = true;
            $http.get($rootScope.backendAddress + '/procurement/master/AlurPengadaanServices/getList')
        ...
        $scope.pilihAlur = function (alur) {
            ...
            if (typeof alur.kondisiPengadaan.metodePenyampaianDokumenPengadaan !== 'undefined' && alur.kondisiPengadaan.metodePenyampaianDokumenPengadaan !== null) {
                vm.dataPengadaan.metodePenyampaianDokumenPengadaan = {
            ...
            if (typeof alur.kondisiPengadaan.metodePenawaranHarga !== 'undefined') {
                vm.dataPengadaan.metodePenawaranHarga = {
            ...
            if (typeof alur.kondisiPengadaan.jenisPenawaran !== 'undefined') {
                vm.dataPengadaan.jenisPenawaran = {
            ...
            if (typeof alur.kondisiPengadaan.sistemEvaluasiPenawaran !== 'undefined') {
                vm.dataPengadaan.sistemEvaluasiPenawaran = {
                    id: alur.kondisiPengadaan.sistemEvaluasiPenawaran.id,
                    nama: alur.kondisiPengadaan.sistemEvaluasiPenawaran.nama
                };
            }
            if (typeof alur.kondisiPengadaan.metodePengadaan !== 'undefined') {
                vm.dataPengadaan.metodePengadaan = {
                    id: alur.kondisiPengadaan.metodePengadaan.id,
                    nama: alur.kondisiPengadaan.metodePengadaan.nama
                };
            }
            //aktifkan tombol undangan jika pemilihan dan penunjukan
            if (vm.dataPengadaan.metodePengadaan.id == 5 || vm.dataPengadaan.metodePengadaan.id == 4) {
        ...
        $scope.autoLoadMaterial = function () {
            if (vm.dataPengadaan.materialPengadaanList !== undefined && vm.dataPengadaan.materialPengadaanList !== null && vm.dataPengadaan.materialPengadaanList.length > 0) {
            	...
            	// digabung item dan jasa,
                $http.get($rootScope.backendAddress + '/procurement/inisialisasi/ItemPengadaanServices/getItemPengadanByPengadaanId/' + vm.dataPengadaan.id)
                    .success(function (data, status, headers, config) {
        ...
        $scope.getPerencanaanPengadaanDetil = function (perencanaan) {
            ...
            perencanaanModalInstance.result.then(function () {
                ...
                angular.forEach(vm.dataPengadaan.materialPengadaanList, function (valueMaterial, indexMaterial) {
                    vm.dataPengadaan.deleteMaterialPengadaanList.push(valueMaterial);
                });
                vm.dataPengadaan.materialPengadaanList = $rootScope.inisialisasiForm.materialList;
                $scope.autoLoadMaterial();
                $scope.tableMaterialList.reload();
                $scope.updateJumlahMaterialNilaiHPSPPN();
            }, function () {
                ...
                if ($scope.itemPerencanaanList.length > 0) {
                    ...
                    angular.forEach($scope.itemPerencanaanList, function (value, key) {
                        var materialObject = {
                            ...
                            nilaiHPS: value.price,
                            totalHPS: value.quantity * value.price,
                    ...
                    if ($rootScope.prPengadaan.length > 0) {
                        $rootScope.prPengadaan[0].purchaseRequest = $scope.detilPerencanaan;
                        $rootScope.prPengadaan.isChange = true;
                    }
                }
                $modalInstance.close('closed');
            }
        ...
        $http.get($rootScope.backendAddress + '/procurement/inisialisasi/purchaserequestpengadaan/findByPengadaanId/' + vm.dataPengadaan.id)
            .success(function (dataPRPengadaan) {
                $rootScope.prPengadaan = dataPRPengadaan;
                $rootScope.prPengadaan.isChange = false;
            });
            ...
            if (vm.dataPengadaan.jasaPengadaanList !== undefined && vm.dataPengadaan.jasaPengadaanList !== null && vm.dataPengadaan.jasaPengadaanList.length > 0) {
                ...
                $http.get($rootScope.backendAddress + '/procurement/inisialisasi/ItemPengadaanServices/getItemPengadaanJasaByPengadaanId/' + vm.dataPengadaan.id)
                    .success(function (data, status, headers, config) {
                        ...
                        console.log($scope.tableJasaList);
        ...
        $scope.btnTambahBidang = function () {
            ...
            modalTambahSubBidangUsaha.result.then(function (dataBidangUsahaList) {
                ...
                if (typeof $scope.tableBidangUsahaVendor === 'undefined') {
                    $scope.tableBidangUsahaVendor = new ngTableParams({
                        page: 1,
                        count: 5
                    }, {
        ...
        //data undangan vendor
        vm.dataPengadaan.undanganVendorList = [];
        vm.dataPengadaan.undanganVendorStatus = false;

        //console.log("load data udangan vendor! vm.dataPengadaan.metodePengadaan.id:" + vm.dataPengadaan.metodePengadaan.id);
        // jika metode pengadaan adalah penunjukan langsung dan pemilihan langsung request undangan vendor
        if (vm.dataPengadaan.metodePengadaan.id == 5 || vm.dataPengadaan.metodePengadaan.id == 4) {
            vm.dataPengadaan.undanganVendorStatus = true;
            if (vm.dataPengadaan.undanganVendorList !== undefined && vm.dataPengadaan.undanganVendorList !== null && vm.dataPengadaan.undanganVendorList.length > 0) {
                // console.log("vendor undanga exist!")                    
            } else {
            ...
            //console.log("Vendor undangan : " + JSON.stringify(vm.dataPengadaan.undanganVendorList));
        } else {
            vm.dataPengadaan.undanganVendorStatus = false;
        }
        ...
        $scope.btnUndangVendor = function () {
            ...
            modalTambahUndangVendor.result.then(function (undanganVendorList) {
                ...
                //console.log("data : "+JSON.stringify(undanganVendorList));
                if (typeof $scope.tableUndanganVendor === 'undefined') {
                    $scope.tableUndanganVendor = new ngTableParams({
                        page: 1,
                        count: 5
                    }, {
        ...
        var uploader = $scope.uploader = new FileUploader({
            url: $scope.uploadBackendAddress,
            method: 'POST'
        });
        ...
        $http.get($rootScope.backendAddress + '/procurement/pengadaan/dokumenPengadaanServices/getDokumenPengadaanByPengadaanIdList/' + vm.dataPengadaan.id)
            .success(function (data, status, headers, config) {
                ...
                for (var y = 0; y < vm.dataPengadaan.dokumenPengadaanList.length; y++){
                    ...
                    item.realFileName = vm.dataPengadaan.dokumenPengadaanList[y].path;
                }
            });
        ...
        uploader.onCompleteItem = function (fileItem, response, status, headers) {
            ...
            //console.info("JSON fileupload : ", fileItem);
            //console.info("uploader : ", uploader);
            //uploader.queue[fileItem.uploader.queue.length].file.fileNameServer = response.fileName;
            //console.log("wedus : " + response.fileName);
        };
        ...
        $scope.btnUpdateInisialisasi = function () {
            ...
            ModalService.showModalConfirmation().then(function (result) {
            	if(vm.dataPengadaan.dokumenPengadaanList.length>0){
                var formPostPengadaan = {
                    ...
                    alurPengadaan: $scope.alurSelected,
                ...
                if (vm.dataPengadaan.jenisPenawaran.id === 1) {
                    ...
                    if(vm.dataPengadaan.prosentasePajakJasa == null) {
                    	 formPostPengadaan.prosentasePajakJasa = vm.dataPengadaan.prosentasePajakMaterial;
                    } else {
                ...
                $http({
                    ...
                    if (typeof data !== 'undefined') {
                        ...
                        // simpan jika penunjukan / pemilihan langsung
                        if (vm.dataPengadaan.metodePengadaan.id == 5 || vm.dataPengadaan.metodePengadaan.id == 4) {
                        ...
                        //Update PR jika ada perubahan
                        if ($rootScope.prPengadaan.length > 0) {
                            if ($rootScope.prPengadaan.isChange == true) {
                                $http({
                                        method: 'POST',
                                        url: $rootScope.backendAddress + '/procurement/inisialisasi/purchaserequestpengadaan/edit',
                                        headers: {
                                            'Content-Type': 'application/x-www-form-urlencoded'
                                        },
                                        transformRequest: function (obj) {
                                        ...
                                        data: {
                                            id: $rootScope.prPengadaan[0].id,
                                            pengadaan: $rootScope.prPengadaan[0].pengadaan.id,
                                            purchaseRequest: $rootScope.prPengadaan[0].purchaseRequest.id
                                        }
                                    })
            	...
            	$scope.isProcessing = false;
            	RequestService.modalInformation('Dokumen undangan harus ada!', 'danger')   	
            }
            }, function(close){
            	$scope.isProcessing = false;
            });
        ...
        $scope.insertItemPengadaanMaterial = function (pengadaanId) {
            ...
            angular.forEach(vm.dataPengadaan.materialPengadaanList, function (dataMaterial, index) {
                ...
                if (vm.dataPengadaan.jenisPenawaran.id === 2) {
                    if (typeof dataMaterial.jenisPajak === 'undefined' || dataMaterial.jenisPajak == null) {
            ...
            if (vm.dataPengadaan.deleteMaterialPengadaanList !== undefined && vm.dataPengadaan.deleteMaterialPengadaanList !== null && vm.dataPengadaan.deleteMaterialPengadaanList.length > 0) {
                angular.forEach(vm.dataPengadaan.deleteMaterialPengadaanList, function (deleteMaterial, index) {
                    var targetURI = $rootScope.backendAddress + '/procurement/inisialisasi/ItemPengadaanServices/deleteItemPengadaan/' + deleteMaterial.id;
                    $http.get(targetURI)
                        .success(function (rs) {
                        })
                });
        ...
        $scope.insertJasaPengadaan = function (pengadaanId, jasaPengadaan, itemId) {
            ...
            if (jasaPengadaan.pengadaan.jenisPenawaran.id === 2) {
        ...
        $scope.insertBidang = function (pengadaanId) {
            ...
            if (vm.dataPengadaan.deleteSubBidangUsahaList !== undefined && vm.dataPengadaan.deleteSubBidangUsahaList !== null && vm.dataPengadaan.deleteSubBidangUsahaList.length > 0) {
                angular.forEach(vm.dataPengadaan.deleteSubBidangUsahaList, function (deleteSubBidangUsaha, index) {
                    var targetURI = $rootScope.backendAddress + '/procurement/inisialisasi/BidangUsahaPengadaanServices/deleteRowBidangUsahaPengadaan/' + deleteSubBidangUsaha.bidangUsahaPengadaanId;
                    $http.get(targetURI)
                        .success(function (rs) {
                            //delete biang usaha
                        })
        ...
        $scope.insertVendor = function (pengadaanId) {
            ...
            // vendor
            if (vm.dataPengadaan.undanganVendorStatus == true) {
                if (vm.dataPengadaan.undanganVendorList !== undefined && vm.dataPengadaan.undanganVendorList !== null && vm.dataPengadaan.undanganVendorList.length > 0) {
                    ...
                    if (vm.dataPengadaan.deleteUndanganVendorList !== undefined && vm.dataPengadaan.deleteUndanganVendorList !== null && vm.dataPengadaan.deleteUndanganVendorList.length > 0) {
                        angular.forEach(vm.dataPengadaan.deleteUndanganVendorList, function (deleteUndanganVendor, index) {
                            var targetURI = $rootScope.backendAddress + '/procurement/inisialisasi/undanganVendorServices/deleteRowUndanganVendorByPengadaanVendor/' + pengadaanId+'/'+deleteUndanganVendor.id;
                            $http.get(targetURI)
                                .success(function (data) {
                                    //delete vendor
                                });
        ...
        uploader.onCompleteItem = function (fileItem, response, status, headers) {
        	...
        	var item={
        			...
        			nama:fileItem.file.name,
        			fileSize:fileItem.file.size,
        			pengadaan:{id:vm.dataPengadaan.id}
        			}
        	vm.dataPengadaan.dokumenPengadaanList.push(item);
        };
        //Inser Dokumen
        $scope.insertDokumenUpload = function (pengadaanId) {
            //dokumen upload
        	console.log(JSON.stringify(vm.dataPengadaan.dokumenPengadaanList));
        	RequestService.doPOSTJSON('/procurement/pengadaan/dokumenPengadaanServices/insert', vm.dataPengadaan.dokumenPengadaanList);

        }

        $scope.removeItemDokumen = function (data,index) {
        	
            data.remove();
            vm.dataPengadaan.dokumenPengadaanList.splice(index, 1);
        }
        $scope.removeAllItemDokumen = function() {
        	uploader.clearQueue()
        	vm.dataPengadaan.dokumenPengadaanList=[];
        }
    ...
    InisialisasiPengadaanBumnEditController.$inject = ['ModalService', '$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter', 'ngTableParams', '$modal', 'FileUploader', '$q', '$stateParams', 'RequestService'];
