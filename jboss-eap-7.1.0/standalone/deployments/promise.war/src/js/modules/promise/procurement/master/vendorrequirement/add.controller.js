(function () {
    ...
    angular.module('naut').controller('VendorRequirementTambahController', VendorRequirementTambahController);

    function VendorRequirementTambahController($scope, $http, $rootScope, $resource, $location, toaster) {
        var form = this;
        form.pengadaan = {};
        form.mataUang = {};
    ...
    VendorRequirementTambahController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster'];
