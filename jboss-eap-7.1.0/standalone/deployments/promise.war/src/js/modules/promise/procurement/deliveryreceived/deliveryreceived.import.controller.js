...
angular.module('naut').controller('DeliveryReceivedImportController', ['FileUploader', 'RequestService','$scope','$rootScope', '$state', function(FileUploader, RequestService, $state, $scope,$rootScope) {
    
	var vm 		= this;
	vm.template = RequestService.templateXls('templateDR');
	vm.isDisable=true;
	
	vm.uploader = new FileUploader({
        url: RequestService.readDRImport(),
		headers : {
