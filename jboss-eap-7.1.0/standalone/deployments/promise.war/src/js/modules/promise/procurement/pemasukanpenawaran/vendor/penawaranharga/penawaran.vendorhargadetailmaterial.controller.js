(function () {
    ...
    angular.module('naut').controller('PenawaranHargaDetailMaterialController', PenawaranHargaDetailMaterialController);

    function PenawaranHargaDetailMaterialController($scope, $http, $rootScope, $resource, $location, toaster, $modal) {
        var pptc = this;
    ...
    PenawaranHargaDetailMaterialController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$modal'];
