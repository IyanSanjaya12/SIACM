(function () {
    ...
    angular
        .module('naut')
        .controller('UsulanCalonPemenangTotalSistemGugurController', UsulanCalonPemenangTotalSistemGugurController);

    function UsulanCalonPemenangTotalSistemGugurController($http, $scope, $rootScope, $resource, $location, $modal, toaster, $q, $timeout, ngTableParams, $filter) {
        ...
        $scope.list = [];
        $scope.loading = true;
        if ($scope.detailPengadaan.metodePenawaranHarga.id == 1) {
            ...
            $http.get($rootScope.backendAddress + '/procurement/evaluasiharga/EvaluasiHargaVendorServices/getListByPengadaan/' + $scope.pengadaanId)
                .success(function (auction, status, headers, config) {
        ...
        $scope.goModalConfirmation = function (data) {
            ...
            $rootScope.updateTahapanPengadaan = $scope.updatePengadaan;
        ...
        var ModalInstanceConfirmationCtrl = function ($scope, $http, $modalInstance, $resource, $rootScope) {
            ...
            $scope.ok = function () {
                ...
                $rootScope.updateTahapanPengadaan();
    ...
    UsulanCalonPemenangTotalSistemGugurController.$inject = ['$http', '$scope', '$rootScope', '$resource', '$location', '$modal', 'toaster', '$q', '$timeout', 'ngTableParams', '$filter'];
})();