...
(function () {
    ...
    angular
        .module('naut')
        .controller('PengambilanDokumenViewController', PengambilanDokumenViewController);

    function PengambilanDokumenViewController(ModalService, $scope, $http, $rootScope, $resource, $location, $filter, ngTableParams, $modal, $q) {
        var form = this;
    ...
    PengambilanDokumenViewController.$inject = ['ModalService', '$scope', '$http', '$rootScope', '$resource', '$location', '$filter', 'ngTableParams', '$modal', '$q'];
