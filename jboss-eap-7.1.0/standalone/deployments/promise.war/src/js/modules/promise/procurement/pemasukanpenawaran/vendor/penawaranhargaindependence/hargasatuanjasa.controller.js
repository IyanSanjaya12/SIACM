(function () {
    ...
    angular.module('naut').controller('PenawaranVendorIndependenceHargaSatuanJasaController', PenawaranVendorIndependenceHargaSatuanJasaController);

    function PenawaranVendorIndependenceHargaSatuanJasaController($scope, $http, $rootScope, $resource, $location, toaster, $modal, $state, $filter) {
        var pptc = this;
    ...
    PenawaranVendorIndependenceHargaSatuanJasaController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$modal', '$state', '$filter'];
