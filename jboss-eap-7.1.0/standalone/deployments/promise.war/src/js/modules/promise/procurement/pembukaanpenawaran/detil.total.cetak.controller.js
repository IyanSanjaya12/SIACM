...
(function () {
    ...
    angular
        .module('naut')
        .controller('PembukaanPenawaranTotalCetakController', PembukaanPenawaranTotalCetakController);

    function PembukaanPenawaranTotalCetakController(ModalService, $http, $scope, $rootScope, $resource, $location, $modal, $q, $timeout, ngTableParams, toaster) {
    ...
    PembukaanPenawaranTotalCetakController.$inject = ['ModalService', '$http', '$scope', '$rootScope', '$resource', '$location', '$modal', '$q', '$timeout', 'ngTableParams', 'toaster'];
})();