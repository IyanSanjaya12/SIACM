(function () {
    ...
    angular.module('naut').controller('HistoryAuctionSimpleViewController', HistoryAuctionSimpleViewController);

    function HistoryAuctionSimpleViewController($scope, $http, $rootScope, $location, toaster, $resource, $filter, $modal, ngTableParams) {
        ...
        //console.log('sesi auction : '+JSON.stringify(detailSesiAuction));
                    ...
                    if (data[index].totalPenawaranKonfersi == $scope.hargaTerbaik) {
                        if (hargaTerbaikSebelumnya != $scope.hargaTerbaik) {
                            ...
                            var isiList = {
                                ...
                                hargaTerbaik: data[index].totalPenawaranKonfersi,
                                hargaTerbaikNoKurs :data[index].nilaiPenawaran,
                                mataUang: data[index].mataUang.kode,
                                status: statusAuction
                            }
                            hargaTerbaikSebelumnya = data[index].totalPenawaranKonfersi;
    ...
    HistoryAuctionSimpleViewController.$inject = ['$scope', '$http', '$rootScope', '$location', 'toaster', '$resource', '$filter', '$modal', 'ngTableParams'];
