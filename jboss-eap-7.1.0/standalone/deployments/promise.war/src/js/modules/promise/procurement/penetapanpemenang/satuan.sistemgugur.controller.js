(function () {
    ...
    angular
        .module('naut')
        .controller('SatuanSistemGugurController', SatuanSistemGugurController);

    function SatuanSistemGugurController($http, $scope, $rootScope, $resource, $location, $modal, toaster, $q, $timeout, ngTableParams) {
        var form = this;
    ...
    SatuanSistemGugurController.$inject = ['$http', '$scope', '$rootScope', '$resource', '$location', '$modal', 'toaster', '$q', '$timeout', 'ngTableParams'];
})();
