/**=========================================================
 * Module: negosiasi.satuan.detail.penawaran.more.controller.js
 * Modul/Tahapan ID: 15
 * Author: Reinhard
 =========================================================*/
...
(function() {
    ...
    angular
        .module('naut')
        .controller('NegosiasiSatuanDetailPenawaranMoreController', NegosiasiSatuanDetailPenawaranMoreController);

    function NegosiasiSatuanDetailPenawaranMoreController($scope, $http, $rootScope, $resource, $location, toaster, $filter, $stateParams) {
       ...
       loadDetilPenawaran();
        ...
        $scope.back = function() {
            ...
            $location.path('/app/promise/procurement/negosiasi/satuan/detail/penawaran/' + $stateParams.pengadaanId+'/'+$scope.itemPengadaanId );
        };
    ...
    NegosiasiSatuanDetailPenawaranMoreController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter', '$stateParams'];
