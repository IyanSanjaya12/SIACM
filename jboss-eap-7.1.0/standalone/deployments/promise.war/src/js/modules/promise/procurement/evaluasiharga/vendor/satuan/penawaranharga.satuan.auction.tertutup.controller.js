/**=========================================================
 * Module: PenawaranHargaSatuanTertutupAddController.js
 * Author: F.H.K
 =========================================================*/
...
(function() {
    ...
    angular
        .module('naut')
        .controller('PenawaranHargaSatuanTertutupAddController', PenawaranHargaSatuanTertutupAddController);

    function PenawaranHargaSatuanTertutupAddController($http, $rootScope, $resource, $location, $window, toaster, $scope, $filter, ngTableParams) {
		
		/* ======================= Pendeklarasian Variable Lokal/Interlokal ============================== */
        $scope.pengadaanId = $scope.detilPengadaan.id;
		$scope.tahapanId = $scope.detilPengadaan.tahapanPengadaan.tahapan.id;
        ...
        $scope.clickDetail = function(data) {
            ...
            $scope.go('/appvendor/promise/procurement/evaluasiharga/vendor/satuan/auction/detail/tertutup');
        }
	...
	PenawaranHargaSatuanTertutupAddController.$inject = ['$http', '$rootScope', '$resource', '$location', '$window', 'toaster', '$scope', '$filter', 'ngTableParams'];
