(function () {
    ...
    angular
        .module('naut')
        .controller('MonitoringWorklistController', MonitoringWorklistController);

    function MonitoringWorklistController($scope, $http, $rootScope, $resource, $location, $modal, $stateParams, $state) {
        var vm = this;
		$scope.loading = true;
		$http.get($rootScope.backendAddress+'/procurement/approvalProcessServices/get-my-monitoring-worklist')
    ...
    MonitoringWorklistController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', '$modal', '$stateParams', '$state'];
