(function () {
    ...
    angular.module('naut')
        .controller('KebutuhanMaterialTambahController', KebutuhanMaterialTambahController)
        .filter('propsFilter', propsFilter)
        .filter('formatMoney', formatMoney);

    function KebutuhanMaterialTambahController($scope, $http, $rootScope, $resource, $location, toaster, $filter) {
    ...
    KebutuhanMaterialTambahController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter'];
