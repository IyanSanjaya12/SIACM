(function () {
	...
	angular.module('naut')
		.controller('UndangVendorPengadaanController', UndangVendorPengadaanController);

	function UndangVendorPengadaanController($scope, $http, $rootScope, $resource, $location, toaster, $filter, ngTableParams) {
...
//		}
	...
	UndangVendorPengadaanController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter', 'ngTableParams'];
