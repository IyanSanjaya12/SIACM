...
(function () {
	...
	angular
		.module('naut')
		.controller('AdminSLAPerpanjanganVendorController', AdminSLAPerpanjanganVendorController);

	function AdminSLAPerpanjanganVendorController(ModalService, RequestService, $filter, $scope, $http, $rootScope, $resource, $location, $modal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $compile, $ocLazyLoad) {

		/** load js sub modul **/
		$ocLazyLoad.load('src/js/modules/promise/procurement/adminslavendor/perpanjangan/adminslavendor.perpanjangan.view.controller.js'); 
        ...
        form.getDataList = function () {
            ...
            form.dtOptions = RequestService.requestServerPagging(DTOptionsBuilder.newOptions(), '/procurement/vendor/SLAAdminVendorServices/getSLAAdminVendorPaggingList/PERPANJANGAN', form.filter);
        ...
        form.slaVendorPerpanjangan = function (instance) {
            form.dtInstance = instance.slaVendorPerpanjangan;
        }
        
        form.viewDetail = function(id){
        	$rootScope.slaAdminVendorId = id;
			$location.path('/app/promise/procurement/adminslavendor/perpanjangan/view');
        }
	}

	AdminSLAPerpanjanganVendorController.$inject = ['ModalService', 'RequestService', '$filter', '$scope', '$http', '$rootScope', '$resource', '$location', '$modal', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTInstances', '$compile', '$ocLazyLoad'];
