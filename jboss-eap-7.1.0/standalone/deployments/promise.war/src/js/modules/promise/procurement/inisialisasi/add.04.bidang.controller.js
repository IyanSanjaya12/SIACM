(function() {
    ...
    angular.module('naut')
		.controller('BidangPengadaan04Controller', BidangPengadaan04Controller)
        .filter('propsFilter', propsFilter);
	function BidangPengadaan04Controller($scope, $http, $rootScope, $resource, $location, toaster, $filter, ngTableParams) {
		$scope.bidangUsaha = {};
	...
	BidangPengadaan04Controller.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter', 'ngTableParams'];
