(function () {
    ...
    angular.module('naut').controller('EvaluasiHargaTotalViewController', EvaluasiHargaTotalViewController);

    function EvaluasiHargaTotalViewController(ModalService, $scope, $http, $rootScope, $location, toaster, $resource, $filter, $modal, $interval, $state, RequestService, ngTableParams) {
        ...
        var lanjutTahapan = function () {
            ...
            $http({
                ...
                $scope.loading = false;
                $state.go('app.promise.procurement-panitia-evaluasiharga-auction');
            });
        }
    ...
    EvaluasiHargaTotalViewController.$inject = ['ModalService', '$scope', '$http', '$rootScope', '$location', 'toaster', '$resource', '$filter', '$modal', '$interval', '$state', 'RequestService', 'ngTableParams'];
