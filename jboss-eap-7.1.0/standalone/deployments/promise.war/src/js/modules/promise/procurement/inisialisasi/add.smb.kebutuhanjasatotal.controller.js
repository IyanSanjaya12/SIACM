(function () {
    ...
    angular.module('naut')
        .controller('KebutuhanJasaTambahSMBController', KebutuhanJasaTambahSMBController)
        .filter('propsFilter', propsFilter)
        .filter('formatMoney', formatMoney);

    function KebutuhanJasaTambahSMBController($scope, $http, $rootScope, $resource, $location, toaster, $filter) {
        ...
        //		$scope.kodeJasa = {};
        //		$scope.refreshkodeJasaList = function(kodeJasa) {
        //			$scope.loading = true;
        //			if(kodeJasa.length == 0)
        //				kodeJasa = 0;
        //			
        //			return $http.get($rootScope.backendAddress + '/procurement/master/ItemServices/get-list-by-kode/'+kodeJasa)
        //				.then(function(response) {
        //					$scope.kodeJasaList = response.data;
        //					$scope.loading = false;
        //				});
        //		};
        //		$scope.setKodeJasaSelected = function(){
        //			if(typeof $scope.kodeJasa.selected !== 'undefined'){
        //				vm.namaJasa = $scope.kodeJasa.selected.nama;
        //				//console.log('INFO : '+JSON.stringify($scope.kodeJasa.selected));
        //				vm.jenisJasa = $scope.kodeJasa.selected.itemGroupId.nama;
        //				vm.satuan = $scope.kodeJasa.selected.satuanId.nama;
        //			}
        //		};
    ...
    KebutuhanJasaTambahSMBController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter'];
