...
var Grid = fc.Grid = RowRenderer.extend({
	...
	headCellHtml: function(cell) {
		...
		return '' +
			'<th scope="col"class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '">' +
...
var BasicView = fcViews.basic = View.extend({
	...
	headIntroHtml: function() {
		if (this.weekNumbersVisible) {
			return '' +
				'<th scope="col"class="fc-week-number ' + this.widgetHeaderClass + '" ' + this.weekNumberStyleAttr() + '>' +
...
var AgendaView = fcViews.agenda = View.extend({
	...
	headIntroHtml: function() {
		...
		if (this.opt('weekNumbers')) {
			...
			return '' +
				'<th scope="col"class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + '>' +
					'<span>' + // needed for matchCellWidths
						htmlEscape(weekText) +
					'</span>' +
				'</th>';
			...
			return '<th scope="col"class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + '></th>';
		}
	},
