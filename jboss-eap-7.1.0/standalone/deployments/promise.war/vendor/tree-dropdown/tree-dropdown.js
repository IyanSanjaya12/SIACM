...
function treeDropdown($compile){
    var template = "<div class='select' ng-click='openTree()'><p>{{selected.label}}</p></div>";
    ...
    function getOptions(scope, data, level){
        ...
        angular.forEach(data, function(obj){
            ...
            var optionA = angular.element("<p ng-class='{selected:selected.id=="+obj.id+"}' class='level-"+level+"'>"+obj.label+"</p>");
