...
module
    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile','$localStorage', 'RequestService','$location',
        function(fileUploaderOptions, $rootScope, $http, $window, $compile, $localStorage,RequestService,$location) {
            /**
            ...
            function FileUploader(options) {
            	fileUploaderOptions.headers.Authorization = $rootScope.userToken;
                ...
                /*BNI CUSTOM*/ /*@rei*/
                this.filters.unshift({name: 'customFilter', 
                	
                	fn: function (item /*{File|FileLikeObject}*/ , options) {
                    	RequestService.uploadFilter(this, item, true);
                    	return (RequestService.uploadFilter(this, item, false) && (this.queue.length < 10));
                    }
            ...
            FileUploader.prototype._transformResponse = function(response, headers) {
                ...
                angular.forEach($http.defaults.transformResponse, function(transformFn) {
                    ...
                    if (typeof response =='object')
                    	...
                    	{
                       	var errorCode = response.substr(response.indexOf("PRMS-ERR"), 12);
