...
(function WeakMapModule() {
  ...
  /**
   * Security depends on HIDDEN_NAME being both <em>unguessable</em> and
   * <em>undiscoverable</em> by untrusted code.
   *
   ...
   *     JavaScript code.
   * <li>Preventing <em>certification theft</em>, where one object is
   *     created falsely claiming to be the key of an association
   *     actually keyed by another object.
   * <li>Preventing <em>value theft</em>, where untrusted code with
