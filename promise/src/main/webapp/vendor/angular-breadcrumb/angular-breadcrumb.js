...
function $Breadcrumb() {
    ...
    this.$get = ['RequestService', '$state', '$stateParams', '$rootScope', function(RequestService, $state, $stateParams, $rootScope) {
        ...
        var $$parentState = function(state) {
            ...
            if(state != null){
            	// custom verdy untuk menentukan apakah object conf memiliki sub object ncyBreadcrumb
                var status = 'parent' in state;
                if(status){ 
        ...
        var $$addStateInChain = function(chain, stateRef) {
            ...
            if(conf != null){
            	// custom verdy untuk menentukan apakah object conf memiliki sub object ncyBreadcrumb
                var status = 'ncyBreadcrumb' in conf;
...
function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
    var $$templates = {
        bootstrap2: 
            '<div ng-repeat="step in steps" ng-switch="$last || !!step.abstract">'
