(function() {
    ...
    angular.module('naut')
		.controller('BidangPengadaanController', BidangPengadaanController)
        .filter('propsFilter', propsFilter);
	function BidangPengadaanController($scope, $http, $rootScope, $resource, $location, toaster, $filter, ngTableParams) {
		$scope.bidangUsaha = {};
	...
	BidangPengadaanController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter', 'ngTableParams'];
