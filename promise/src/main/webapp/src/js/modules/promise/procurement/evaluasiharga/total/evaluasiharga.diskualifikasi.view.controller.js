(function() {
    ...
    angular.module('naut').controller('DiskualifikasiViewController', DiskualifikasiViewController);

    function DiskualifikasiViewController(ModalService, $scope, $http, $rootScope, $location, toaster, $resource, $filter, $modal, ngTableParams) {
    ...
    DiskualifikasiViewController.$inject = ['ModalService', '$scope', '$http', '$rootScope', '$location', 'toaster', '$resource', '$filter', '$modal', 'ngTableParams'];
