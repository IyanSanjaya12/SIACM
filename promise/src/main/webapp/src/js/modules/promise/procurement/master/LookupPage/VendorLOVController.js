angular.module('naut').controller('VendorModal', function($scope, $modalInstance, RequestService) {
	$scope.maxSize = 5;
	$scope.currentPage = 1;
	...
	$scope.getDataList = function() {        	
		...
		RequestService.requestServer('/procurement/vendor/vendorServices/indexPageList', params)
		.then(function (data) {
