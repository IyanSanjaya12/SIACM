/**=========================================================
 * Module: PenawaranHargaSatuanDetailTerbukaAddController.js
 * Author: F.H.K
 =========================================================*/
...
(function() {
    ...
    angular
        .module('naut')
        .controller('PenawaranHargaSatuanDetailTerbukaAddController', PenawaranHargaSatuanDetailTerbukaAddController);

    function PenawaranHargaSatuanDetailTerbukaAddController($http, $rootScope, $resource, $location, $window, toaster, $scope, $filter, ngTableParams) {
        ...
        $scope.mulaiAuction = function() {
            ...
            if($scope.hideTombol != 1) {
                if(tanggalInput > tanggalAkhirSesi) {
                    ...
                    $scope.go('/appvendor/promise/procurement/evaluasiharga/vendor/satuan/pemasukanpenawaran/terbuka');
                }
            } else {
	...
	PenawaranHargaSatuanDetailTerbukaAddController.$inject = ['$http', '$rootScope', '$resource', '$location', '$window', 'toaster', '$scope', '$filter', 'ngTableParams'];
