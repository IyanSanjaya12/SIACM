/**=========================================================
 * Module: PembukaanPenawaranTotalTahapDuaController.js
 =========================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('PembukaanPenawaranTotalTahapDuaController', PembukaanPenawaranTotalTahapDuaController);

    function PembukaanPenawaranTotalTahapDuaController($http, $scope, $rootScope, $resource, $location, $modal, $q, $timeout, ngTableParams, toaster, $stateParams, $filter, editableOptions, editableThemes, $state) {
    ...
    PembukaanPenawaranTotalTahapDuaController.$inject = ['$http', '$scope', '$rootScope', '$resource', '$location', '$modal', '$q', '$timeout', 'ngTableParams', 'toaster', '$stateParams', '$filter', 'editableOptions', 'editableThemes', '$state'];
