(function () {
    ...
    angular
        .module('naut')
        .controller('UsulanCalonPemenangTotalMeritPointController', UsulanCalonPemenangTotalMeritPointController);

    function UsulanCalonPemenangTotalMeritPointController(ModalService, $http, $scope, $rootScope, $resource, $location, $modal, toaster, $q, $timeout, ngTableParams, $filter) {
    ...
    UsulanCalonPemenangTotalMeritPointController.$inject = ['ModalService', '$http', '$scope', '$rootScope', '$resource', '$location', '$modal', 'toaster', '$q', '$timeout', 'ngTableParams', '$filter'];
})();