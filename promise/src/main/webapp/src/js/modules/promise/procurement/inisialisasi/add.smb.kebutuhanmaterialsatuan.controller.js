(function () {
    ...
    angular.module('naut')
        .controller('KebutuhanMaterialSatuanTambahSMBController', KebutuhanMaterialSatuanTambahSMBController)
        .filter('propsFilter', propsFilter)
        .filter('formatMoney', formatMoney);

    function KebutuhanMaterialSatuanTambahSMBController($scope, $http, $rootScope, $resource, $location, toaster, $filter) {
        ...
        $scope.setEditMaterial = function () {
            if (typeof $rootScope.materialEditId !== 'undefined') {
                ...
                vm.jenisMaterial = $scope.kodeMaterial.selected.itemGroupId.nama;
                vm.satuan = $scope.kodeMaterial.selected.satuanId.nama;
                $scope.pajak.selected = $scope.materialObj.jenisPajak;
                $scope.presentase = $scope.materialObj.prosentasePajak;
    ...
    KebutuhanMaterialSatuanTambahSMBController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter'];
