(function () {
    ...
    angular.module('naut').controller('KondisiPengadaanUbahController', KondisiPengadaanUbahController);

    function KondisiPengadaanUbahController($scope, $http, $rootScope, $resource, $location, toaster) {
        var form = this;
        var dataKondisiPengadaan;
        ...
        if (typeof $rootScope.indexKondisiPengadaan !== 'undefined') {
            dataKondisiPengadaan = $rootScope.indexKondisiPengadaan;
        }
        form.id = dataKondisiPengadaan.id;
        form.jenisPengadaan.selected = dataKondisiPengadaan.jenisPengadaan;
        form.metodePengadaan.selected = dataKondisiPengadaan.metodePengadaan;
        form.metodePenyampaianDokumenPengadaan.selected = dataKondisiPengadaan.metodePenyampaianDokumenPengadaan;
        form.metodePenawaranHarga.selected = dataKondisiPengadaan.metodePenawaranHarga;
        form.jenisPenawaran.selected = dataKondisiPengadaan.jenisPenawaran;
        form.sistemEvaluasiPenawaran.selected = dataKondisiPengadaan.sistemEvaluasiPenawaran;
        form.kualifikasiVendor.selected = dataKondisiPengadaan.kualifikasiVendor;
        form.vendorRequirement.selected = dataKondisiPengadaan.vendorRequirement;
        ...
        form.simpan = function () {
            if (typeof form.jenisPengadaan.selected === 'undefined') {
                ...
                $http({
                    method: 'POST',
                    url: $rootScope.backendAddress + '/procurement/master/kondisiPengadaanServices/updateKondisiPengadaan',
                    headers: {
    ...
    KondisiPengadaanUbahController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster'];
