/**============================================================
 * Module: PenunjukanSatuanSistemGugurController.js 
 * Author: G.A.I
 ==============================================================*/
...
(function () {
    ...
    angular
        .module('naut')
        .controller('PenunjukanSatuanSistemGugurController', PenunjukanSatuanSistemGugurController);

    function PenunjukanSatuanSistemGugurController($http, $scope, $rootScope, $resource, $location, $modal, toaster, $q, $timeout, ngTableParams) {
        var form = this;
                    ...
                    angular.forEach(negosiasi, function (value, indeks) {
                        ...
                        $http.get($rootScope.backendAddress + '/procurement/penunjukanpemenangperitem/getByItemByVendorByPengadaan/' + list.id + '/' + value.evaluasiHargaVendor.vendor.id + '/' + $scope.pengadaanId).success(function (penunjukan, status, headers, config) {
                            if (penetapan.length > 0) {
                                ...
                                negosiasi[indeks].nilaiKuantitas = penunjukan[0].nilaiKualitas;
                            }
                        })
                    })
        ...
        var modalInstanceController = function ($scope, $http, $modalInstance, $resource, $rootScope, data1, data2) {
            ...
            var getPenetapanPenunjukanList = function (itemId, vendorId, pengadaanId) {
            ...
            $scope.ok = function () {
                ...
                if (checkPemenang.nilaiKuantitas > $scope.data.kuantitas) {
    ...
    PenunjukanSatuanSistemGugurController.$inject = ['$http', '$scope', '$rootScope', '$resource', '$location', '$modal', 'toaster', '$q', '$timeout', 'ngTableParams'];
})();
