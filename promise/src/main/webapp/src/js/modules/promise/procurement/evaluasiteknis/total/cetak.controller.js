(function () {
    ...
    angular.module('naut')
        .controller('EvaluasiTeknisTotalViewCetakController', EvaluasiTeknisTotalViewCetakController);

    function EvaluasiTeknisTotalViewCetakController(ModalService, $scope, $http, $rootScope, $resource, $location, toaster, $window, $modal, $q, $timeout, $filter, ngTableParams) {
        var form = this;
        $scope.back = function () {
    ...
    EvaluasiTeknisTotalViewCetakController.$inject = ['ModalService', '$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$window', '$modal', '$q', '$timeout', '$filter', 'ngTableParams'];
