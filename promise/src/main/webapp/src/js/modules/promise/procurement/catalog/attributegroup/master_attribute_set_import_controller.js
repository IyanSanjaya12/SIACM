...
angular.module('naut').controller('AttributeGroupImportController', ['FileUploader', 'RequestService', '$state', function(FileUploader, RequestService, $state) {
    
	var vm 		= this;
	vm.template = RequestService.templateXls('templateAttGroup');
	
	vm.uploader = new FileUploader({
		url: RequestService.readAttGrImport()
    });
