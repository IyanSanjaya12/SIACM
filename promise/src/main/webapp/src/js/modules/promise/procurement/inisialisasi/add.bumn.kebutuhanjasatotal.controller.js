(function () {
    ...
    angular.module('naut')
        .controller('KebutuhanJasaTambahController', KebutuhanJasaTambahController)
        .filter('propsFilter', propsFilter)
        .filter('formatMoney', formatMoney);

    function KebutuhanJasaTambahController($scope, $http, $rootScope, $resource, $location, toaster, $filter) {
    ...
    KebutuhanJasaTambahController.$inject = ['$scope', '$http', '$rootScope', '$resource', '$location', 'toaster', '$filter'];
