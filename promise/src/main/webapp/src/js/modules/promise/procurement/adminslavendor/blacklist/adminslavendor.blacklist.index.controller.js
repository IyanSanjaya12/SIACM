...
(function () {
	...
	angular
		.module('naut')
		.controller('AdminSLABlacklistVendorController', AdminSLABlacklistVendorController);

	function AdminSLABlacklistVendorController(ModalService, RequestService, $filter, $scope, $http, $rootScope, $resource, $location, $modal, DTOptionsBuilder, DTColumnBuilder, DTInstances, $compile, $ocLazyLoad) {

		/** load js sub modul **/
		$ocLazyLoad.load('src/js/modules/promise/procurement/adminslavendor/blacklist/adminslavendor.blacklist.view.controller.js'); 
        ...
        form.getDataList = function () {
            ...
            form.dtOptions = RequestService.requestServerPagging(DTOptionsBuilder.newOptions(), '/procurement/vendor/SLAAdminVendorServices/getSLAAdminVendorPaggingList/BLACKLIST', form.filter);
        ...
        form.slaVendorBlacklist = function (instance) {
            form.dtInstance = instance.slaVendorBlacklist;
        }
	...
	AdminSLABlacklistVendorController.$inject = ['ModalService', 'RequestService', '$filter', '$scope', '$http', '$rootScope', '$resource', '$location', '$modal', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTInstances', '$compile', '$ocLazyLoad'];
