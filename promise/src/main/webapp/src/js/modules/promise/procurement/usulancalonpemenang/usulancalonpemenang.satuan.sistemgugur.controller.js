(function () {
    ...
    angular
        .module('naut')
        .controller('UsulanCalonPemenangSatuanSistemGugurController', UsulanCalonPemenangSatuanSistemGugurController);

    function UsulanCalonPemenangSatuanSistemGugurController($http, $scope, $rootScope, $resource, $location, $modal, toaster, $q, $timeout, ngTableParams) {
        var form = this;
    ...
    UsulanCalonPemenangSatuanSistemGugurController.$inject = ['$http', '$scope', '$rootScope', '$resource', '$location', '$modal', 'toaster', '$q', '$timeout', 'ngTableParams'];
})();
